package com.karanjaa.CarYardManagementSystem.data
...
import com.karanjaa.CarYardManagementSystem.models.Product
import com.karanjaa.CarYardManagementSystem.models.Upload
...
class ProductViewModel(var navController: NavHostController, var context: Context) {
    ...
    fun saveProduct(productName: String, productQuantity: String, productPrice: String,productModel:String) {
        var id = System.currentTimeMillis().toString()
        var productData = Product(productName, productQuantity, productPrice,productModel, id)
    ...
    fun updateProduct(name: String, quantity: String, price: String, id: String,model:String) {
        var updateRef = FirebaseDatabase.getInstance().getReference()
            .child("Products/$id")
        progress.show()
        var updateData = Product(name, quantity, price,model, id)
    ...
    fun saveProductWithImage(productName:String, productQuantity:String, productPrice:String,productModel:String, filePath: Uri){
        var id = System.currentTimeMillis().toString()
            ...
            if (it.isSuccessful){
                ...
                storageReference.downloadUrl.addOnSuccessListener {
                    ...
                    var houseData = Upload(productName,productQuantity,
                        productPrice,productModel,imageUrl,id)
